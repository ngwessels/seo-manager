...
class RobotsHelper extends React.Component {
  static async getInitialProps({
    res,
    req
  }) {
...
exports.RobotsHelper = RobotsHelper;
exports.SEOInit = SEOInit;
exports.SEOinitialize = SEOinitialize;
exports.SitemapHelper = SitemapHelper;
...
exports.returnKey = returnKey$1;
exports.returnProject = returnProject;
